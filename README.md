...
This repository contains the code used for Task1 and Task 3 for the AIcrowd Multi-Agent Behaviour Challenge (MABe). For more information about the implementation, please refer to the [paper](documents/Final_Project_CS_7643.pdf).
